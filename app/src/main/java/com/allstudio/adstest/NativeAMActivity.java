...
public class NativeAMActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_native_am);
        findViewById(R.id.ibnm_load).setOnClickListener(view -> loadAd());
        findViewById(R.id.ibnm_show).setOnClickListener(view -> showAd());
        frameLayout = findViewById(R.id.ibnm_ad_placeholder);
        loadAd();
    }
    ...
    private void loadAd() {
        if(mNativeAd == null){
            ...
            AdLoader adLoader = new AdLoader.Builder(NativeAMActivity.this, getResources().getString(R.string.adnm_unit_id))
